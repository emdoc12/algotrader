...
SECRET_KEYS = [
    ...
    "GITHUB_TOKEN", "DISCORD_WEBHOOK_URL", "ALPHAVANTAGE_API_KEY",
]
PLAIN_KEYS = [
    "CLAUDE_MODEL", "OPENAI_MODEL", "XAI_MODEL", "QWEN_MODEL",
    "DEEPSEEK_MODEL", "GLM_MODEL", "KIMI_MODEL",
    ...
    "MAX_PORTFOLIO_HEAT_PCT", "COOLDOWN_DRAWDOWN_PCT", "DAILY_LOSS_LIMIT_PCT",
    "ALLOW_AVERAGE_DOWN", "STRATEGY_COMMIT_DAYS", "MAX_STRATEGY_ALLOCATION_PCT",
    "AUTO_SCALE_DEFAULT_R", "AUTO_SCALE_DEFAULT_FRAC",
    "APP_ICON_PATH",
    "MAX_OPTION_RISK_PCT", "MAX_OPTION_COLLATERAL_PCT", "OPTION_STRESS_MOVE_PCT",
    "OPTION_COMMISSION_PER_CONTRACT", "ALPHAVANTAGE_DAILY_LIMIT",
